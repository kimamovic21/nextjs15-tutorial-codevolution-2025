...
const Search = () => {
  return (
    <Form action='/products-db' className='flex gap-2'>
      ...
      <button
        type='submit'
        className='px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer'
      >
        Submit
      </button>
    </Form>
